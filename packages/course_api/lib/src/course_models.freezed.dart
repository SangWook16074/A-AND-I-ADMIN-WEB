...
mixin _$AssignmentMetadata {
 ...
 String get title; String get difficulty; String? get description; int? get timeLimitMinutes; List<LearningGoal> get learningGoals; List<AssignmentRequirement> get requirements; List<AssignmentExample> get examples; Map<String, dynamic> get attributes; Map<String, dynamic>? get problemDetail; Map<String, dynamic>? get submissionGuide; List<Map<String, dynamic>> get codeTemplates;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AssignmentMetadata&&(identical(other.title, title) || other.title == title)&&(identical(other.difficulty, difficulty) || other.difficulty == difficulty)&&(identical(other.description, description) || other.description == description)&&(identical(other.timeLimitMinutes, timeLimitMinutes) || other.timeLimitMinutes == timeLimitMinutes)&&const DeepCollectionEquality().equals(other.learningGoals, learningGoals)&&const DeepCollectionEquality().equals(other.requirements, requirements)&&const DeepCollectionEquality().equals(other.examples, examples)&&const DeepCollectionEquality().equals(other.attributes, attributes)&&const DeepCollectionEquality().equals(other.problemDetail, problemDetail)&&const DeepCollectionEquality().equals(other.submissionGuide, submissionGuide)&&const DeepCollectionEquality().equals(other.codeTemplates, codeTemplates));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,difficulty,description,timeLimitMinutes,const DeepCollectionEquality().hash(learningGoals),const DeepCollectionEquality().hash(requirements),const DeepCollectionEquality().hash(examples),const DeepCollectionEquality().hash(attributes),const DeepCollectionEquality().hash(problemDetail),const DeepCollectionEquality().hash(submissionGuide),const DeepCollectionEquality().hash(codeTemplates));

@override
String toString() {
  return 'AssignmentMetadata(title: $title, difficulty: $difficulty, description: $description, timeLimitMinutes: $timeLimitMinutes, learningGoals: $learningGoals, requirements: $requirements, examples: $examples, attributes: $attributes, problemDetail: $problemDetail, submissionGuide: $submissionGuide, codeTemplates: $codeTemplates)';
}
...
@useResult
$Res call({
 String title, String difficulty, String? description, int? timeLimitMinutes, List<LearningGoal> learningGoals, List<AssignmentRequirement> requirements, List<AssignmentExample> examples, Map<String, dynamic> attributes, Map<String, dynamic>? problemDetail, Map<String, dynamic>? submissionGuide, List<Map<String, dynamic>> codeTemplates
});
...
/// Create a copy of AssignmentMetadata
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? difficulty = null,Object? description = freezed,Object? timeLimitMinutes = freezed,Object? learningGoals = null,Object? requirements = null,Object? examples = null,Object? attributes = null,Object? problemDetail = freezed,Object? submissionGuide = freezed,Object? codeTemplates = null,}) {
  return _then(_self.copyWith(
title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
...
as Map<String, dynamic>?,submissionGuide: freezed == submissionGuide ? _self.submissionGuide : submissionGuide // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,codeTemplates: null == codeTemplates ? _self.codeTemplates : codeTemplates // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String difficulty,  String? description,  int? timeLimitMinutes,  List<LearningGoal> learningGoals,  List<AssignmentRequirement> requirements,  List<AssignmentExample> examples,  Map<String, dynamic> attributes,  Map<String, dynamic>? problemDetail,  Map<String, dynamic>? submissionGuide,  List<Map<String, dynamic>> codeTemplates)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AssignmentMetadata() when $default != null:
return $default(_that.title,_that.difficulty,_that.description,_that.timeLimitMinutes,_that.learningGoals,_that.requirements,_that.examples,_that.attributes,_that.problemDetail,_that.submissionGuide,_that.codeTemplates);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String difficulty,  String? description,  int? timeLimitMinutes,  List<LearningGoal> learningGoals,  List<AssignmentRequirement> requirements,  List<AssignmentExample> examples,  Map<String, dynamic> attributes,  Map<String, dynamic>? problemDetail,  Map<String, dynamic>? submissionGuide,  List<Map<String, dynamic>> codeTemplates)  $default,) {final _that = this;
switch (_that) {
case _AssignmentMetadata():
return $default(_that.title,_that.difficulty,_that.description,_that.timeLimitMinutes,_that.learningGoals,_that.requirements,_that.examples,_that.attributes,_that.problemDetail,_that.submissionGuide,_that.codeTemplates);case _:
  throw StateError('Unexpected subclass');
...
class _AssignmentMetadata implements AssignmentMetadata {
  const _AssignmentMetadata({this.title = '', this.difficulty = 'MID', this.description, this.timeLimitMinutes, final  List<LearningGoal> learningGoals = const [], final  List<AssignmentRequirement> requirements = const [], final  List<AssignmentExample> examples = const [], final  Map<String, dynamic> attributes = const {}, final  Map<String, dynamic>? problemDetail, final  Map<String, dynamic>? submissionGuide, final  List<Map<String, dynamic>> codeTemplates = const []}): _learningGoals = learningGoals,_requirements = requirements,_examples = examples,_attributes = attributes,_problemDetail = problemDetail,_submissionGuide = submissionGuide,_codeTemplates = codeTemplates;
...
@override Map<String, dynamic>? get problemDetail {
 ...
 final  Map<String, dynamic>? _submissionGuide;
@override Map<String, dynamic>? get submissionGuide {
  final value = _submissionGuide;
  if (value == null) return null;
  if (_submissionGuide is EqualUnmodifiableMapView) return _submissionGuide;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(value);
}

 final  List<Map<String, dynamic>> _codeTemplates;
@override@JsonKey() List<Map<String, dynamic>> get codeTemplates {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AssignmentMetadata&&(identical(other.title, title) || other.title == title)&&(identical(other.difficulty, difficulty) || other.difficulty == difficulty)&&(identical(other.description, description) || other.description == description)&&(identical(other.timeLimitMinutes, timeLimitMinutes) || other.timeLimitMinutes == timeLimitMinutes)&&const DeepCollectionEquality().equals(other._learningGoals, _learningGoals)&&const DeepCollectionEquality().equals(other._requirements, _requirements)&&const DeepCollectionEquality().equals(other._examples, _examples)&&const DeepCollectionEquality().equals(other._attributes, _attributes)&&const DeepCollectionEquality().equals(other._problemDetail, _problemDetail)&&const DeepCollectionEquality().equals(other._submissionGuide, _submissionGuide)&&const DeepCollectionEquality().equals(other._codeTemplates, _codeTemplates));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,difficulty,description,timeLimitMinutes,const DeepCollectionEquality().hash(_learningGoals),const DeepCollectionEquality().hash(_requirements),const DeepCollectionEquality().hash(_examples),const DeepCollectionEquality().hash(_attributes),const DeepCollectionEquality().hash(_problemDetail),const DeepCollectionEquality().hash(_submissionGuide),const DeepCollectionEquality().hash(_codeTemplates));
...
/// Create a copy of AssignmentMetadata
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? difficulty = null,Object? description = freezed,Object? timeLimitMinutes = freezed,Object? learningGoals = null,Object? requirements = null,Object? examples = null,Object? attributes = null,Object? problemDetail = freezed,Object? submissionGuide = freezed,Object? codeTemplates = null,}) {
...
as Map<String, dynamic>?,submissionGuide: freezed == submissionGuide ? _self._submissionGuide : submissionGuide // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,codeTemplates: null == codeTemplates ? _self._codeTemplates : codeTemplates // ignore: cast_nullable_to_non_nullable
as List<Map<String, dynamic>>,
  ));
}

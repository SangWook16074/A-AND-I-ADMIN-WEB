...
part of 'tasks_management_providers.dart';
...
final addEnrollmentUseCaseProvider = Provider<AddEnrollmentUseCase>.internal(
  addEnrollmentUseCase,
  name: r'addEnrollmentUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$addEnrollmentUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
